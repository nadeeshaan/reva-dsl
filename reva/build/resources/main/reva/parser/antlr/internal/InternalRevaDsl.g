...
@lexer::header {
package reva.parser.antlr.internal;
...
@parser::members {
 	...
 	private RevaDslGrammarAccess grammarAccess;

    public InternalRevaDslParser(TokenStream input, RevaDslGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected RevaDslGrammarAccess getGrammarAccess() {
	...
	(
		...
		(
			(
				(
					{
						newCompositeNode(grammarAccess.getModelAccess().getExpressionsXExpressionOrVarDeclarationParserRuleCall_1_0_0());
					}
			...
			(
				otherlv_2=';'
				{
					newLeafNode(otherlv_2, grammarAccess.getModelAccess().getSemicolonKeyword_1_1());
				}
			)?
		)*
	)
...
@after {
	...
	(
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getPrintExpressionAccess().getExpressionXExpressionParserRuleCall_2_0());
				}
...
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getXPrimaryExpressionAccess().getPrintExpressionParserRuleCall_0());
		}
		this_PrintExpression_0=rulePrintExpression
		{
			$current = $this_PrintExpression_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
@after {
	...
	(
		...
		(
			('extends' | 'static' | 'import' | 'extension' | '!' | '-' | '+' | 'print' | 'new' | '{' | 'switch' | 'synchronized' | '<' | 'super' | '#' | '[' | 'false' | 'true' | 'null' | 'typeof' | 'if' | 'for' | 'while' | 'do' | 'throw' | 'return' | 'try' | '(' | RULE_ID | RULE_HEX | RULE_INT | RULE_DECIMAL | RULE_STRING)=>
			(
				{
